...
var obstaculo1 = this.sensor.intersectObjetcts(environment.children,true);

this.sensor.set(this.position, new THREE.Vector3(-1,0,0));
var obstaculo2 = this.sensor.intersectObjetcts(environment.children,true);                        
...
if (this.colision ==1)
    ...
    function Pared(size, z=0, y=0) {
    THREE.Objetc3D.call(this,x,y);
